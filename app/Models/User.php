 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Board> $boards_owner
 * @property-read int|null $boards_owner_count
 * @mixin \Eloquent
 */
class User extends Authenticatable implements JWTSubject
{
    ...
    public function boards_owner(): HasMany
    {
    ...
    {
        return user()->role === RoleEnum::MANAGER->value;
    }
